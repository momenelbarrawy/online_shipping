...
if (isset($_POST['update']) && !empty($_POST['update'])) {
  // $userid = $_POST['update'];
  // $s = $admin->update_user();
  header("Location: http://localhost/pj/online_shipping/Views/Admin/updateUser.php");
  exit;
  // if ($s) {
  //   echo "<div class=\"alert alert-danger alert-dismissible py-3\">
  //           <button type=\"button\" class=\"btn-close\" data-bs-dismiss=\"alert\"></button>
            ...
            <div class="navbar-nav mr-auto py-0">
              ...
              <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu bg-primary rounded-0 border-0 m-0">
                  ...
                  <a href="../Buyer/checkout.html" class="dropdown-item">Checkout</a>
                </div>
              </div>
  ...
  <div class="container my-5">
    <table class="table table-dark table-hover">
      ...
      <tbody>
        ...
        $result = $admin->veiw_users();
        $numbersOfUsers = count($result);
        for ($i = 0; $i < $numbersOfUsers; $i++) {

        ?>
          <tr class="table-light">
            <th scope="row"><?php echo $result[$i]["userid"]; ?></th>
            ...
            <td>
              ...
              <form action="updateUser.php" method="get" style="display: inline-block;">
                <button class="btn btn-dark mr-3" type="submit" value="<?php echo $result[$i]["userid"]; ?>" name="update">Update</button>
              </form>
              <form action="" method="post" style="display: inline-block;">
                <button class="btn btn-danger" value="<?php echo $result[$i]["userid"]; ?>" type="submit" name="delete">Delete</button>
              </form>
            </td>
          </tr>
          <!--  -->
