...
if(isset($_POST['comment']))
{
    ...
    {
        $comment=new comment;
        $comment->setcommentText=$_POST['comment'];
        /*
            ------------Put Product Id instead of '3' and UserId Who log in instead of '1' ----------------
        */
        $CommentsController->AddComment($_POST['comment'],'1','3');
    }
    else
    {
        $emptyComment='Empty comment does not allow';
    }
}

/*
-----------------------Put Product Id instead of '3'------------------ 
*/
$comments= $CommentsController->getcommentsForProduct(3);


if(isset($_POST['submit'])) {
    $newComment = $_POST['newcomment'];
    $commentId = $_POST['commentId']; 
    $CommentsController->updateComment($commentId, $newComment); 
}
            ...
            <div class="col-lg-3 d-none d-lg-block">
                ...
                <nav class="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 bg-light" id="navbar-vertical" style="width: calc(100% - 30px); z-index: 999;">
                    <div class="navbar-nav w-100">
                        ...
                        </div>                        <a href="" class="nav-item nav-link">Mobiles & Tablets</a>
            ...
            <div class="col">
                <div class="bg-light p-30">
                    <div class="nav nav-tabs mb-4">
                        ...
                        <div class=" show active" id="tab-pane-3">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="media mb-4">
                                        <div class="media-body">
                                            ...
                                            foreach ($comments as $comment) {
                                                ...
                                                echo '<h6>' . $comment['username'] . '</h6>';
                                                echo '<p style="padding-left:10px;">' . $comment['commenttext'] . '</p>';
                                                /*

                                                    -------------------UserId Who log in instead of 2-----------

                                                */
                                                if ($comment['commenterid'] == 2) {
                                                    echo '<form action="">';
                                                    echo '<input type="text" value="'.$comment['commenttext'].'" class="form-control" style="border:1px solid #f44336;background:#ffff;padding:5px 10px;outline:none;" name="newcomment"></input>';
                                                    echo '</form>';
                                                    echo '<form action="">';
                                                    echo '<input type="submit" value="Update" style="border:none;background:#f44336;padding:5px 10px;margin-left:160%;" name="update"></input>';
                                                    echo '</form>';
                                                } 
                                                echo '</div>';
                                                echo '</div>';
                                ...
                                <div class="col-md-6">
                                    ...
                                    <form action="detail.php"method="POST">
                                        <div class="form-group">
                                            ...
                                            <p style="color: red;"><?php echo $emptyComment?></p>
                                        </div>
